...
export default function AccordionDemo({ spriteUrl }: { spriteUrl: string }) {
  return (
    <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
      <AccordionItem value="item-1">
        <AccordionTrigger spriteUrl={spriteUrl}>Product Information</AccordionTrigger>
      ...
      <AccordionItem value="item-2">
        <AccordionTrigger spriteUrl={spriteUrl}>Shipping Details</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance">
      ...
      <AccordionItem value="item-3">
        <AccordionTrigger spriteUrl={spriteUrl}>Return Policy</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance">
