...
export const Select = forwardRef(function Select({ className, multiple, ...props }: { className?: string } & Omit<Headless.SelectProps, 'as' | 'className'>, ref: ForwardedRef<HTMLSelectElement>) {
  const headlessRef = ref as Ref<HTMLElement>;
