...
export function DropdownButton<T extends ElementType = typeof Button>({ as = Button, ...props }: { className?: string } & Omit<Headless.MenuButtonProps<T>, 'className'>) {
...
export function DropdownItem({ className, ...props }: { className?: string } & (Omit<Headless.MenuItemProps<'button'>, 'as' | 'className'> | Omit<Headless.MenuItemProps<typeof Link>, 'as' | 'className'>)) {
  const classes = clsx(
    className,
    // Base styles
...
export function DropdownHeader({ className, ...props }: ComponentPropsWithoutRef<'div'>) {
