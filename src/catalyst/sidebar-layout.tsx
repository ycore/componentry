...
export function SidebarLayout({ navbar, sidebar, className, children }: React.PropsWithChildren<{ navbar: React.ReactNode; sidebar: React.ReactNode; className?: string }>) {
