...
export function Legend({ className, ...props }) {
    return _jsx(Headless.Legend, { "data-slot": "legend", ...props, className: clsx(className, 'font-semibold text-base/6 text-zinc-950 data-disabled:opacity-50 sm:text-sm/6 dark:text-white') });
}
...
export function Label({ className, ...props }) {
    return _jsx(Headless.Label, { "data-slot": "label", ...props, className: clsx(className, 'select-none text-base/6 text-zinc-950 data-disabled:opacity-50 sm:text-sm/6 dark:text-white') });
}
