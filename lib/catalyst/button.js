...
export function TouchTarget({ children }) {
    return (_jsxs(_Fragment, { children: [_jsx("span", { className: "-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 size-[max(100%,2.75rem)] [@media(pointer:fine)]:hidden", "aria-hidden": "true" }), children] }));
}
