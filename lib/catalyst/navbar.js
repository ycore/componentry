...
export function NavbarSection({ className, ...props }) {
    const id = useId();
    return (_jsx("div", { id: id, children: _jsx("div", { ...props, className: clsx(className, 'flex items-center gap-3') }) }));
}
