...
function MobileSidebar({ open, close, className, children }) {
    return (_jsxs(Headless.Dialog, { open: open, onClose: close, className: "lg:hidden", children: [_jsx(Headless.DialogBackdrop, { transition: true, className: "fixed inset-0 bg-black/30 transition data-closed:opacity-0 data-enter:duration-300 data-leave:duration-200 data-enter:ease-out data-leave:ease-in" }), _jsx(Headless.DialogPanel, { transition: true, className: "data-closed:-translate-x-full fixed inset-y-0 w-full max-w-80 p-2 transition duration-300 ease-in-out", children: _jsxs("div", { className: clsx([className ?? 'bg-white dark:bg-zinc-900', 'flex h-full flex-col rounded-lg shadow-xs ring-1 ring-zinc-950/5 dark:ring-white/10']), children: [_jsx("div", { className: "-mb-3 px-4 pt-3", children: _jsx(Headless.CloseButton, { as: NavbarItem, "aria-label": "Close navigation", children: _jsx(CloseMenuIcon, {}) }) }), children] }) })] }));
}
export function StackedLayout({ navbar, sidebar, className, children }) {
    const [showSidebar, setShowSidebar] = useState(false);
    return (_jsxs("div", { className: clsx([children && 'min-h-svh', className ?? 'bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950', 'relative isolate flex w-full flex-col']), children: [_jsx(MobileSidebar, { open: showSidebar, close: () => setShowSidebar(false), children: sidebar }), _jsxs("header", { className: "flex items-center px-4", children: [_jsx("div", { className: "py-2.5 lg:hidden", children: _jsx(NavbarItem, { onClick: () => setShowSidebar(true), "aria-label": "Open navigation", children: _jsx(OpenMenuIcon, {}) }) }), _jsx("div", { className: "min-w-0 flex-1", children: navbar })] }), children && (_jsx("main", { className: "flex flex-1 flex-col pb-2 lg:px-2", children: _jsx("div", { className: clsx(['grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10']), children: _jsx("div", { className: "mx-auto max-w-6xl", children: children }) }) }))] }));
}
