...
export function Avatar({ src = null, square = false, initials, alt = '', className, ...props }) {
    return (_jsxs("span", { "data-slot": "avatar", ...props, className: clsx(className, 
        // Basic layout
        'inline-grid shrink-0 align-middle [--avatar-radius:20%] [--ring-opacity:20%] *:col-start-1 *:row-start-1', '-outline-offset-1 outline outline-black/(--ring-opacity) dark:outline-white/(--ring-opacity)', 
