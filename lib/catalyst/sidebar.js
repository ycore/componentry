...
export function SidebarSection({ className, ...props }) {
    const id = useId();
    return (_jsx("div", { id: id, children: _jsx("div", { ...props, "data-slot": "section", className: clsx(className, 'flex flex-col gap-0.5') }) }));
}
...
export const SidebarItem = forwardRef(function SidebarItem({ current, className, children, ...props }, ref) {
    ...
    return (_jsxs("span", { className: clsx(className, 'relative'), children: [current && _jsx("span", { className: "-left-4 absolute inset-y-2 w-0.5 rounded-full bg-zinc-950 dark:bg-white" }), 'href' in props ? (_jsx(Headless.CloseButton, { as: Link, ...props, className: classes, "data-current": current ? 'true' : undefined, ref: ref, children: _jsx(TouchTarget, { children: children }) })) : (_jsx(Headless.Button, { ...props, className: clsx('cursor-default', classes), "data-current": current ? 'true' : undefined, ref: ref, children: _jsx(TouchTarget, { children: children }) }))] }));
});
