...
export function DropdownItem({ className, ...props }) {
    ...
    // Icons
    '*:data-[slot=icon]:-ml-0.5 *:data-[slot=icon]:col-start-1 *:data-[slot=icon]:row-start-1 *:data-[slot=icon]:mr-2.5 *:data-[slot=icon]:size-5 sm:*:data-[slot=icon]:mr-2 sm:*:data-[slot=icon]:size-4', 'data-focus:*:data-[slot=icon]:text-white *:data-[slot=icon]:text-zinc-500 dark:data-focus:*:data-[slot=icon]:text-white dark:*:data-[slot=icon]:text-zinc-400', 
    // Avatar
...
export function DropdownHeading({ className, ...props }) {
    return _jsx(Headless.MenuHeading, { ...props, className: clsx(className, 'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 font-medium text-sm/5 text-zinc-500 sm:px-3 sm:text-xs/5 dark:text-zinc-400') });
}
...
export function DropdownLabel({ className, ...props }) {
    return _jsx(Headless.Label, { ...props, "data-slot": "label", className: clsx(className, 'col-start-2 row-start-1'), ...props });
}
