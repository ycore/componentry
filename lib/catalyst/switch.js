...
export function Switch({ color = 'dark/zinc', className, ...props }) {
    return (_jsx(Headless.Switch, { "data-slot": "control", ...props, className: clsx(className, 
        ...
        // Hover
        'data-hover:data-checked:ring-(--switch-bg-ring) data-hover:ring-black/15', 'dark:data-hover:data-checked:ring-(--switch-bg-ring) dark:data-hover:ring-white/25', 
        // Disabled
        'data-disabled:data-checked:bg-zinc-200 data-disabled:data-checked:ring-black/5 data-disabled:bg-zinc-200 data-disabled:opacity-50', 'dark:data-disabled:data-checked:bg-white/15 dark:data-disabled:data-checked:ring-white/15 dark:data-disabled:bg-white/15', 
