...
var Link = React.forwardRef(function Link2(props, ref) {
  return /* @__PURE__ */ jsx(Headless.DataInteractive, { children: /* @__PURE__ */ jsx(RouterLink, { ...props, to: props.href, ref }) });
});

// src/catalyst/text.tsx
import { jsx as jsx2 } from "react/jsx-runtime";
function Text({ className, ...props }) {
  return /* @__PURE__ */ jsx2("p", { "data-slot": "text", ...props, className: clsx(className, "text-base/6 text-zinc-500 sm:text-sm/6 dark:text-zinc-400") });
}
function TextLink({ className, ...props }) {
  return /* @__PURE__ */ jsx2(Link, { ...props, className: clsx(className, "text-zinc-950 underline decoration-zinc-950/50 data-hover:decoration-zinc-950 dark:text-white dark:decoration-white/50 dark:data-hover:decoration-white") });
}
function Strong({ className, ...props }) {
  return /* @__PURE__ */ jsx2("strong", { ...props, className: clsx(className, "font-medium text-zinc-950 dark:text-white") });
}
function Code({ className, ...props }) {
  return /* @__PURE__ */ jsx2("code", { ...props, className: clsx(className, "rounded-sm border border-zinc-950/10 bg-zinc-950/[2.5%] px-0.5 font-medium text-sm text-zinc-950 sm:text-[0.8125rem] dark:border-white/20 dark:bg-white/5 dark:text-white") });
}
...
function Alert({ size = "md", className, children, ...props }) {
  return /* @__PURE__ */ jsxs(Headless2.Dialog, { ...props, children: [
    /* @__PURE__ */ jsx3(
    ...
    /* @__PURE__ */ jsx3("div", { className: "fixed inset-0 w-screen overflow-y-auto pt-6 sm:pt-0", children: /* @__PURE__ */ jsx3("div", { className: "grid min-h-full grid-rows-[1fr_auto_1fr] justify-items-center p-8 sm:grid-rows-[1fr_auto_3fr] sm:p-4", children: /* @__PURE__ */ jsx3(
...
function AlertTitle({ className, ...props }) {
  return /* @__PURE__ */ jsx3(Headless2.DialogTitle, { ...props, className: clsx2(className, "text-balance text-center font-semibold text-base/6 text-zinc-950 sm:text-wrap sm:text-left sm:text-sm/6 dark:text-white") });
}
function AlertDescription({ className, ...props }) {
  return /* @__PURE__ */ jsx3(Headless2.Description, { as: Text, ...props, className: clsx2(className, "mt-2 text-pretty text-center sm:text-left") });
}
function AlertBody({ className, ...props }) {
  return /* @__PURE__ */ jsx3("div", { ...props, className: clsx2(className, "mt-4") });
}
function AlertActions({ className, ...props }) {
  return /* @__PURE__ */ jsx3("div", { ...props, className: clsx2(className, "mt-6 flex flex-col-reverse items-center justify-end gap-3 *:w-full sm:mt-4 sm:flex-row sm:*:w-auto") });
}

// src/catalyst/auth-layout.tsx
import { jsx as jsx4 } from "react/jsx-runtime";
function AuthLayout({ children }) {
  return /* @__PURE__ */ jsx4("main", { className: "flex min-h-dvh flex-col p-2", children: /* @__PURE__ */ jsx4("div", { className: "flex grow items-center justify-center p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10", children }) });
}
...
var Button2 = forwardRef(function Button3({ color, outline, plain, className, children, ...props }, ref) {
  ...
  return "href" in props ? /* @__PURE__ */ jsx5(Link, { ...props, className: classes, ref, children: /* @__PURE__ */ jsx5(TouchTarget, { children }) }) : /* @__PURE__ */ jsx5(Headless3.Button, { ...props, className: clsx3(classes, "cursor-default"), ref, children: /* @__PURE__ */ jsx5(TouchTarget, { children }) });
});
function TouchTarget({ children }) {
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsx5("span", { className: "-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 size-[max(100%,2.75rem)] [@media(pointer:fine)]:hidden", "aria-hidden": "true" }),
    children
  ] });
}
...
function Avatar({ src = null, square = false, initials, alt = "", className, ...props }) {
  return /* @__PURE__ */ jsxs3(
    "span",
    {
      ...
      children: [
        initials && // biome-ignore lint/a11y/noSvgWithoutTitle:
        /* @__PURE__ */ jsxs3("svg", { className: "size-full select-none fill-current p-[5%] font-medium text-[48px] uppercase", viewBox: "0 0 100 100", "aria-hidden": alt ? void 0 : "true", children: [
          alt && /* @__PURE__ */ jsx6("title", { children: alt }),
          /* @__PURE__ */ jsx6("text", { x: "50%", y: "50%", alignmentBaseline: "middle", dominantBaseline: "middle", textAnchor: "middle", dy: ".125em", children: initials })
        ] }),
        src && /* @__PURE__ */ jsx6("img", { className: "size-full", src, alt })
      ]
    }
  );
}
var AvatarButton = forwardRef2(function AvatarButton2({ src, square = false, initials, alt, className, ...props }, ref) {
  ...
  return "href" in props ? /* @__PURE__ */ jsx6(Link, { ...props, className: classes, ref, children: /* @__PURE__ */ jsx6(TouchTarget, { children: /* @__PURE__ */ jsx6(Avatar, { src, square, initials, alt }) }) }) : /* @__PURE__ */ jsx6(Headless4.Button, { ...props, className: classes, ref, children: /* @__PURE__ */ jsx6(TouchTarget, { children: /* @__PURE__ */ jsx6(Avatar, { src, square, initials, alt }) }) });
});
...
function Badge({ color = "zinc", className, ...props }) {
  return /* @__PURE__ */ jsx7("span", { ...props, className: clsx5(className, "inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 font-medium text-sm/5 sm:text-xs/5 forced-colors:outline", colors[color]) });
}
var BadgeButton = forwardRef3(function BadgeButton2({
  color = "zinc",
  className,
  children,
  ...props
  ...
  return "href" in props ? /* @__PURE__ */ jsx7(Link, { ...props, className: classes, ref, children: /* @__PURE__ */ jsx7(TouchTarget, { children: /* @__PURE__ */ jsx7(Badge, { color, children }) }) }) : /* @__PURE__ */ jsx7(Headless5.Button, { ...props, className: classes, ref, children: /* @__PURE__ */ jsx7(TouchTarget, { children: /* @__PURE__ */ jsx7(Badge, { color, children }) }) });
});
...
function Checkbox2({
  ...
  return /* @__PURE__ */ jsx8(Headless6.Checkbox, { "data-slot": "control", ...props, className: clsx6(className, "group inline-flex focus:outline-hidden"), children: /* @__PURE__ */ jsx8("span", { className: clsx6([base, colors2[color]]), children: /* @__PURE__ */ jsxs4("svg", { className: "size-4 stroke-(--checkbox-check) opacity-0 group-data-checked:opacity-100 sm:h-3.5 sm:w-3.5", viewBox: "0 0 14 14", fill: "none", children: [
    /* @__PURE__ */ jsx8("path", { className: "opacity-100 group-data-indeterminate:opacity-0", d: "M3 8L6 11L11 3.5", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx8("path", { className: "opacity-0 group-data-indeterminate:opacity-100", d: "M3 7H11", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" })
  ] }) }) });
}
...
function Combobox2({
  ...
  return /* @__PURE__ */ jsxs5(Headless7.Combobox, { ...props, multiple: false, virtual: { options: filteredOptions }, onClose: () => setQuery(""), children: [
    /* @__PURE__ */ jsxs5(
      "span",
      {
        "data-slot": "control",
        ...
        children: [
          ...
          /* @__PURE__ */ jsx9(Headless7.ComboboxButton, { className: "group absolute inset-y-0 right-0 flex items-center px-2", children: /* @__PURE__ */ jsxs5(
            "svg",
            {
              ...
              fill: "none",
              children: [
                /* @__PURE__ */ jsx9("path", { d: "M5.75 10.75L8 13L10.25 10.75", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }),
                /* @__PURE__ */ jsx9("path", { d: "M10.25 5.25L8 3L5.75 5.25", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" })
              ]
            }
          ) })
        ]
...
function ComboboxOption2({ children, className, ...props }) {
  ...
  return /* @__PURE__ */ jsxs5(
    Headless7.ComboboxOption,
    {
      ...
      children: [
        /* @__PURE__ */ jsx9("span", { className: clsx7(className, sharedClasses), children }),
        /* @__PURE__ */ jsx9("svg", { className: "relative col-start-2 hidden size-5 self-center stroke-current group-data-selected/option:inline sm:size-4", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsx9("path", { d: "M4 8.5l3 3L12 4", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }) })
      ]
    }
  );
}
function ComboboxLabel({ className, ...props }) {
  return /* @__PURE__ */ jsx9("span", { ...props, className: clsx7(className, "ml-2.5 truncate first:ml-0 sm:ml-2 sm:first:ml-0") });
}
function ComboboxDescription({ className, children, ...props }) {
  return /* @__PURE__ */ jsx9("span", { ...props, className: clsx7(className, "flex flex-1 overflow-hidden text-zinc-500 before:w-2 before:min-w-0 before:shrink group-data-focus/option:text-white dark:text-zinc-400"), children: /* @__PURE__ */ jsx9("span", { className: "flex-1 truncate", children }) });
}
...
function DescriptionList({ className, ...props }) {
  return /* @__PURE__ */ jsx10("dl", { ...props, className: clsx8(className, "grid grid-cols-1 text-base/6 sm:grid-cols-[min(50%,--spacing(80))_auto] sm:text-sm/6") });
}
...
function DescriptionDetails({ className, ...props }) {
  return /* @__PURE__ */ jsx10("dd", { ...props, className: clsx8(className, "pt-1 pb-3 text-zinc-950 sm:border-zinc-950/5 sm:border-t sm:nth-2:border-none sm:py-3 dark:text-white dark:sm:border-white/5") });
}
...
function Dialog3({ size = "lg", className, children, ...props }) {
  return /* @__PURE__ */ jsxs6(Headless8.Dialog, { ...props, children: [
    /* @__PURE__ */ jsx11(
    ...
    /* @__PURE__ */ jsx11("div", { className: "fixed inset-0 w-screen overflow-y-auto pt-6 sm:pt-0", children: /* @__PURE__ */ jsx11("div", { className: "grid min-h-full grid-rows-[1fr_auto] justify-items-center sm:grid-rows-[1fr_auto_3fr] sm:p-4", children: /* @__PURE__ */ jsx11(
...
function DialogTitle3({ className, ...props }) {
  return /* @__PURE__ */ jsx11(Headless8.DialogTitle, { ...props, className: clsx9(className, "text-balance font-semibold text-lg/6 text-zinc-950 sm:text-base/6 dark:text-white") });
}
function DialogDescription({ className, ...props }) {
  return /* @__PURE__ */ jsx11(Headless8.Description, { as: Text, ...props, className: clsx9(className, "mt-2 text-pretty") });
}
function DialogBody({ className, ...props }) {
  return /* @__PURE__ */ jsx11("div", { ...props, className: clsx9(className, "mt-6") });
}
function DialogActions({ className, ...props }) {
  return /* @__PURE__ */ jsx11("div", { ...props, className: clsx9(className, "mt-8 flex flex-col-reverse items-center justify-end gap-3 *:w-full sm:flex-row sm:*:w-auto") });
}
...
function Divider({ soft = false, className, ...props }) {
  return /* @__PURE__ */ jsx12("hr", { ...props, className: clsx10(className, "w-full border-t", soft && "border-zinc-950/5 dark:border-white/5", !soft && "border-zinc-950/10 dark:border-white/10") });
}
...
function Dropdown(props) {
  return /* @__PURE__ */ jsx13(Headless9.Menu, { ...props });
}
function DropdownButton({ as = Button2, ...props }) {
  return /* @__PURE__ */ jsx13(Headless9.MenuButton, { as, ...props });
}
...
function DropdownItem({ className, ...props }) {
  ...
  return "href" in props ? /* @__PURE__ */ jsx13(Headless9.MenuItem, { as: Link, ...props, className: classes }) : /* @__PURE__ */ jsx13(Headless9.MenuItem, { as: "button", type: "button", ...props, className: classes });
}
function DropdownHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx13("div", { ...props, className: clsx11(className, "col-span-5 px-3.5 pt-2.5 pb-1 sm:px-3") });
}
...
function DropdownHeading({ className, ...props }) {
  return /* @__PURE__ */ jsx13(Headless9.MenuHeading, { ...props, className: clsx11(className, "col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 font-medium text-sm/5 text-zinc-500 sm:px-3 sm:text-xs/5 dark:text-zinc-400") });
}
function DropdownDivider({ className, ...props }) {
  return /* @__PURE__ */ jsx13(Headless9.MenuSeparator, { ...props, className: clsx11(className, "col-span-full mx-3.5 my-1 h-px border-0 bg-zinc-950/5 sm:mx-3 dark:bg-white/10 forced-colors:bg-[CanvasText]") });
}
function DropdownLabel({ className, ...props }) {
  return /* @__PURE__ */ jsx13(Headless9.Label, { ...props, "data-slot": "label", className: clsx11(className, "col-start-2 row-start-1"), ...props });
}
...
function DropdownShortcut({ keys, className, ...props }) {
  return /* @__PURE__ */ jsx13(Headless9.Description, { as: "kbd", ...props, className: clsx11(className, "col-start-5 row-start-1 flex justify-self-end"), children: (Array.isArray(keys) ? keys : keys.split("")).map((char, index) => /* @__PURE__ */ jsx13(
    "kbd",
    {
      className: clsx11([
...
function Fieldset2({ className, ...props }) {
  return /* @__PURE__ */ jsx14(Headless10.Fieldset, { ...props, className: clsx12(className, "*:data-[slot=text]:mt-1 [&>*+[data-slot=control]]:mt-6") });
}
function Legend2({ className, ...props }) {
  return /* @__PURE__ */ jsx14(Headless10.Legend, { "data-slot": "legend", ...props, className: clsx12(className, "font-semibold text-base/6 text-zinc-950 data-disabled:opacity-50 sm:text-sm/6 dark:text-white") });
}
function FieldGroup({ className, ...props }) {
  return /* @__PURE__ */ jsx14("div", { "data-slot": "control", ...props, className: clsx12(className, "space-y-8") });
}
...
function Label3({ className, ...props }) {
  return /* @__PURE__ */ jsx14(Headless10.Label, { "data-slot": "label", ...props, className: clsx12(className, "select-none text-base/6 text-zinc-950 data-disabled:opacity-50 sm:text-sm/6 dark:text-white") });
}
function Description5({ className, ...props }) {
  return /* @__PURE__ */ jsx14(Headless10.Description, { "data-slot": "description", ...props, className: clsx12(className, "text-base/6 text-zinc-500 data-disabled:opacity-50 sm:text-sm/6 dark:text-zinc-400") });
}
function ErrorMessage({ className, ...props }) {
  return /* @__PURE__ */ jsx14(Headless10.Description, { "data-slot": "error", ...props, className: clsx12(className, "text-base/6 text-red-600 data-disabled:opacity-50 sm:text-sm/6 dark:text-red-500") });
}
...
function Heading({ className, level = 1, ...props }) {
  ...
  return /* @__PURE__ */ jsx15(Element, { ...props, className: clsx13(className, "font-semibold text-2xl/8 text-zinc-950 sm:text-xl/8 dark:text-white") });
}
function Subheading({ className, level = 2, ...props }) {
  const Element = `h${level}`;
  return /* @__PURE__ */ jsx15(Element, { ...props, className: clsx13(className, "font-semibold text-base/7 text-zinc-950 sm:text-sm/6 dark:text-white") });
}
...
function Listbox2({
  ...
  return /* @__PURE__ */ jsxs7(Headless12.Listbox, { ...props, multiple: false, children: [
    /* @__PURE__ */ jsxs7(
        ...
        children: [
          /* @__PURE__ */ jsx17(
            Headless12.ListboxSelectedOption,
            {
              as: "span",
              options,
              placeholder: placeholder && /* @__PURE__ */ jsx17("span", { className: "block truncate text-zinc-500", children: placeholder }),
              className: clsx15([
                // Basic layout
                "relative block w-full appearance-none rounded-lg py-[calc(--spacing(2.5)-1px)] sm:py-[calc(--spacing(1.5)-1px)]",
          ...
          /* @__PURE__ */ jsx17("span", { className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2", children: /* @__PURE__ */ jsxs7("svg", { className: "size-5 stroke-zinc-500 group-data-disabled:stroke-zinc-600 sm:size-4 dark:stroke-zinc-400 forced-colors:stroke-[CanvasText]", viewBox: "0 0 16 16", "aria-hidden": "true", fill: "none", children: [
            /* @__PURE__ */ jsx17("path", { d: "M5.75 10.75L8 13L10.25 10.75", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }),
            /* @__PURE__ */ jsx17("path", { d: "M10.25 5.25L8 3L5.75 5.25", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" })
          ] }) })
        ]
      }
    ),
...
function ListboxOption2({ children, className, ...props }) {
  ...
  return /* @__PURE__ */ jsx17(Headless12.ListboxOption, { as: Fragment2, ...props, children: ({ selectedOption }) => {
    if (selectedOption) {
      return /* @__PURE__ */ jsx17("div", { className: clsx15(className, sharedClasses), children });
    }
    return /* @__PURE__ */ jsxs7(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx17("svg", { className: "relative hidden size-5 self-center stroke-current group-data-selected/option:inline sm:size-4", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsx17("path", { d: "M4 8.5l3 3L12 4", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }) }),
          /* @__PURE__ */ jsx17("span", { className: clsx15(className, sharedClasses, "col-start-2"), children })
        ]
      }
    );
  } });
...
function ListboxLabel({ className, ...props }) {
  return /* @__PURE__ */ jsx17("span", { ...props, className: clsx15(className, "ml-2.5 truncate first:ml-0 sm:ml-2 sm:first:ml-0") });
}
function ListboxDescription({ className, children, ...props }) {
  return /* @__PURE__ */ jsx17("span", { ...props, className: clsx15(className, "flex flex-1 overflow-hidden text-zinc-500 before:w-2 before:min-w-0 before:shrink group-data-focus/option:text-white dark:text-zinc-400"), children: /* @__PURE__ */ jsx17("span", { className: "flex-1 truncate", children }) });
}
...
function Navbar({ className, ...props }) {
  return /* @__PURE__ */ jsx18("nav", { ...props, className: clsx16(className, "flex flex-1 items-center gap-4 py-2.5") });
}
function NavbarDivider({ className, ...props }) {
  return /* @__PURE__ */ jsx18("div", { "aria-hidden": "true", ...props, className: clsx16(className, "h-6 w-px bg-zinc-950/10 dark:bg-white/10") });
}
function NavbarSection({ className, ...props }) {
  const id = useId();
  return /* @__PURE__ */ jsx18("div", { id, children: /* @__PURE__ */ jsx18("div", { ...props, className: clsx16(className, "flex items-center gap-3") }) });
}
function NavbarSpacer({ className, ...props }) {
  return /* @__PURE__ */ jsx18("div", { "aria-hidden": "true", ...props, className: clsx16(className, "-ml-4 flex-1") });
}
var NavbarItem = forwardRef5(function NavbarItem2({
  current,
  className,
  children,
  ...props
}, ref) {
  const classes = clsx16(
    // Base
  ...
  return /* @__PURE__ */ jsxs8("span", { className: clsx16(className, "relative"), children: [
    current && /* @__PURE__ */ jsx18("span", { className: "-bottom-2.5 absolute inset-x-2 h-0.5 rounded-full bg-zinc-950 dark:bg-white" }),
    "href" in props ? /* @__PURE__ */ jsx18(Link, { ...props, className: classes, "data-current": current ? "true" : void 0, ref, children: /* @__PURE__ */ jsx18(TouchTarget, { children }) }) : /* @__PURE__ */ jsx18(Headless13.Button, { ...props, className: clsx16("cursor-default", classes), "data-current": current ? "true" : void 0, ref, children: /* @__PURE__ */ jsx18(TouchTarget, { children }) })
  ] });
});
function NavbarLabel({ className, ...props }) {
  return /* @__PURE__ */ jsx18("span", { ...props, className: clsx16(className, "truncate") });
}
...
function Pagination({ "aria-label": ariaLabel = "Page navigation", className, ...props }) {
  return /* @__PURE__ */ jsx19("nav", { "aria-label": ariaLabel, ...props, className: clsx17(className, "flex gap-x-2") });
}
function PaginationPrevious({ href = null, className, children = "Previous" }) {
  return /* @__PURE__ */ jsx19("span", { className: clsx17(className, "grow basis-0"), children: /* @__PURE__ */ jsxs9(Button2, { ...href === null ? { disabled: true } : { href }, plain: true, "aria-label": "Previous page", children: [
    /* @__PURE__ */ jsx19("svg", { className: "stroke-current", "data-slot": "icon", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsx19("path", { d: "M2.75 8H13.25M2.75 8L5.25 5.5M2.75 8L5.25 10.5", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }) }),
    children
  ] }) });
}
function PaginationNext({ href = null, className, children = "Next" }) {
  return /* @__PURE__ */ jsx19("span", { className: clsx17(className, "flex grow basis-0 justify-end"), children: /* @__PURE__ */ jsxs9(Button2, { ...href === null ? { disabled: true } : { href }, plain: true, "aria-label": "Next page", children: [
    children,
    /* @__PURE__ */ jsx19("svg", { className: "stroke-current", "data-slot": "icon", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsx19("path", { d: "M13.25 8L2.75 8M13.25 8L10.75 10.5M13.25 8L10.75 5.5", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }) })
  ] }) });
}
function PaginationList({ className, ...props }) {
  return /* @__PURE__ */ jsx19("span", { ...props, className: clsx17(className, "hidden items-baseline gap-x-2 sm:flex") });
}
function PaginationPage({ href, className, current = false, children }) {
  return /* @__PURE__ */ jsx19(
    Button2,
    {
      ...
      children: /* @__PURE__ */ jsx19("span", { className: "-mx-0.5", children })
    }
  );
}
function PaginationGap({ className, children = /* @__PURE__ */ jsx19(Fragment3, { children: "\u2026" }), ...props }) {
  return /* @__PURE__ */ jsx19("span", { "aria-hidden": "true", ...props, className: clsx17(className, "w-[2.25rem] select-none text-center font-semibold text-sm/6 text-zinc-950 dark:text-white"), children });
}
...
function Radio2({ color = "dark/zinc", className, ...props }) {
  return /* @__PURE__ */ jsx20(Headless14.Radio, { "data-slot": "control", ...props, className: clsx18(className, "group inline-flex focus:outline-hidden"), children: /* @__PURE__ */ jsx20("span", { className: clsx18([base2, colors3[color]]), children: /* @__PURE__ */ jsx20(
    "span",
    {
      className: clsx18(
  ...
  return /* @__PURE__ */ jsxs10(
    "span",
    {
      ...
      children: [
        ...
        !multiple && /* @__PURE__ */ jsx21("span", { className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2", children: /* @__PURE__ */ jsxs10("svg", { className: "size-5 stroke-zinc-500 group-has-data-disabled:stroke-zinc-600 sm:size-4 dark:stroke-zinc-400 forced-colors:stroke-[CanvasText]", viewBox: "0 0 16 16", "aria-hidden": "true", fill: "none", children: [
          /* @__PURE__ */ jsx21("path", { d: "M5.75 10.75L8 13L10.25 10.75", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }),
          /* @__PURE__ */ jsx21("path", { d: "M10.25 5.25L8 3L5.75 5.25", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" })
        ] }) })
      ]
    }
  );
...
function OpenMenuIcon() {
  return /* @__PURE__ */ jsx22("svg", { "data-slot": "icon", viewBox: "0 0 20 20", "aria-hidden": "true", children: /* @__PURE__ */ jsx22("path", { d: "M2 6.75C2 6.33579 2.33579 6 2.75 6H17.25C17.6642 6 18 6.33579 18 6.75C18 7.16421 17.6642 7.5 17.25 7.5H2.75C2.33579 7.5 2 7.16421 2 6.75ZM2 13.25C2 12.8358 2.33579 12.5 2.75 12.5H17.25C17.6642 12.5 18 12.8358 18 13.25C18 13.6642 17.6642 14 17.25 14H2.75C2.33579 14 2 13.6642 2 13.25Z" }) });
}
function CloseMenuIcon() {
  return /* @__PURE__ */ jsx22("svg", { "data-slot": "icon", viewBox: "0 0 20 20", "aria-hidden": "true", children: /* @__PURE__ */ jsx22("path", { d: "M6.28 5.22a.75.75 0 0 0-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 1 0 1.06 1.06L10 11.06l3.72 3.72a.75.75 0 1 0 1.06-1.06L11.06 10l3.72-3.72a.75.75 0 0 0-1.06-1.06L10 8.94 6.28 5.22Z" }) });
}
function MobileSidebar({ open, close, className, children }) {
  return /* @__PURE__ */ jsxs11(Headless16.Dialog, { open, onClose: close, className: "lg:hidden", children: [
    /* @__PURE__ */ jsx22(Headless16.DialogBackdrop, { transition: true, className: "fixed inset-0 bg-black/30 transition data-closed:opacity-0 data-enter:duration-300 data-leave:duration-200 data-enter:ease-out data-leave:ease-in" }),
    /* @__PURE__ */ jsx22(Headless16.DialogPanel, { transition: true, className: "data-closed:-translate-x-full fixed inset-y-0 w-full max-w-80 p-2 transition duration-300 ease-in-out", children: /* @__PURE__ */ jsxs11("div", { className: clsx20([className ?? "bg-white dark:bg-zinc-900", "flex h-full flex-col rounded-lg shadow-xs ring-1 ring-zinc-950/5 dark:ring-white/10"]), children: [
      /* @__PURE__ */ jsx22("div", { className: "-mb-3 px-4 pt-3", children: /* @__PURE__ */ jsx22(Headless16.CloseButton, { as: NavbarItem, "aria-label": "Close navigation", children: /* @__PURE__ */ jsx22(CloseMenuIcon, {}) }) }),
      children
    ] }) })
  ] });
}
function SidebarLayout({ navbar, sidebar, className, children }) {
  ...
  return /* @__PURE__ */ jsxs11("div", { className: clsx20([children && "min-h-svh", className ?? "bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950", "relative isolate flex w-full flex-col"]), children: [
    /* @__PURE__ */ jsx22("div", { className: "fixed inset-y-0 left-0 w-64 max-lg:hidden", children: sidebar }),
    /* @__PURE__ */ jsx22(MobileSidebar, { open: showSidebar, close: () => setShowSidebar(false), children: sidebar }),
    /* @__PURE__ */ jsxs11("header", { className: "flex items-center px-4 lg:hidden", children: [
      /* @__PURE__ */ jsx22("div", { className: "py-2.5", children: /* @__PURE__ */ jsx22(NavbarItem, { onClick: () => setShowSidebar(true), "aria-label": "Open navigation", children: /* @__PURE__ */ jsx22(OpenMenuIcon, {}) }) }),
      /* @__PURE__ */ jsx22("div", { className: "min-w-0 flex-1", children: navbar })
    ] }),
    /* @__PURE__ */ jsx22("main", { className: "flex flex-1 flex-col pb-2 lg:min-w-0 lg:pt-2 lg:pr-2 lg:pl-64", children: /* @__PURE__ */ jsx22("div", { className: "grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10", children: /* @__PURE__ */ jsx22("div", { className: "mx-auto max-w-6xl", children }) }) })
  ] });
}
...
function Sidebar({ className, ...props }) {
  return /* @__PURE__ */ jsx23("nav", { ...props, className: clsx21(className, "flex h-full min-h-0 flex-col") });
}
function SidebarHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx23("div", { ...props, className: clsx21(className, "flex flex-col border-zinc-950/5 border-b p-4 dark:border-white/5 [&>[data-slot=section]+[data-slot=section]]:mt-2.5") });
}
function SidebarBody({ className, ...props }) {
  return /* @__PURE__ */ jsx23("div", { ...props, className: clsx21(className, "flex flex-1 flex-col overflow-y-auto p-4 [&>[data-slot=section]+[data-slot=section]]:mt-8") });
}
function SidebarFooter({ className, ...props }) {
  return /* @__PURE__ */ jsx23("div", { ...props, className: clsx21(className, "flex flex-col border-zinc-950/5 border-t p-4 dark:border-white/5 [&>[data-slot=section]+[data-slot=section]]:mt-2.5") });
}
function SidebarSection({ className, ...props }) {
  const id = useId2();
  return /* @__PURE__ */ jsx23("div", { id, children: /* @__PURE__ */ jsx23("div", { ...props, "data-slot": "section", className: clsx21(className, "flex flex-col gap-0.5") }) });
}
function SidebarDivider({ className, ...props }) {
  return /* @__PURE__ */ jsx23("hr", { ...props, className: clsx21(className, "lg:-mx-4 my-4 border-zinc-950/5 border-t dark:border-white/5") });
}
function SidebarSpacer({ className, ...props }) {
  return /* @__PURE__ */ jsx23("div", { "aria-hidden": "true", ...props, className: clsx21(className, "mt-8 flex-1") });
}
function SidebarHeading({ className, ...props }) {
  return /* @__PURE__ */ jsx23("h3", { ...props, className: clsx21(className, "mb-1 px-2 font-medium text-xs/6 text-zinc-500 dark:text-zinc-400") });
}
var SidebarItem = forwardRef7(function SidebarItem2({ current, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ jsxs12("span", { className: clsx21(className, "relative"), children: [
    current && /* @__PURE__ */ jsx23("span", { className: "-left-4 absolute inset-y-2 w-0.5 rounded-full bg-zinc-950 dark:bg-white" }),
    "href" in props ? /* @__PURE__ */ jsx23(Headless17.CloseButton, { as: Link, ...props, className: classes, "data-current": current ? "true" : void 0, ref, children: /* @__PURE__ */ jsx23(TouchTarget, { children }) }) : /* @__PURE__ */ jsx23(Headless17.Button, { ...props, className: clsx21("cursor-default", classes), "data-current": current ? "true" : void 0, ref, children: /* @__PURE__ */ jsx23(TouchTarget, { children }) })
  ] });
});
function SidebarLabel({ className, ...props }) {
  return /* @__PURE__ */ jsx23("span", { ...props, className: clsx21(className, "truncate") });
}
...
function OpenMenuIcon2() {
  return /* @__PURE__ */ jsx24("svg", { "data-slot": "icon", viewBox: "0 0 20 20", "aria-hidden": "true", children: /* @__PURE__ */ jsx24("path", { d: "M2 6.75C2 6.33579 2.33579 6 2.75 6H17.25C17.6642 6 18 6.33579 18 6.75C18 7.16421 17.6642 7.5 17.25 7.5H2.75C2.33579 7.5 2 7.16421 2 6.75ZM2 13.25C2 12.8358 2.33579 12.5 2.75 12.5H17.25C17.6642 12.5 18 12.8358 18 13.25C18 13.6642 17.6642 14 17.25 14H2.75C2.33579 14 2 13.6642 2 13.25Z" }) });
}
function CloseMenuIcon2() {
  return /* @__PURE__ */ jsx24("svg", { "data-slot": "icon", viewBox: "0 0 20 20", "aria-hidden": "true", children: /* @__PURE__ */ jsx24("path", { d: "M6.28 5.22a.75.75 0 0 0-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 1 0 1.06 1.06L10 11.06l3.72 3.72a.75.75 0 1 0 1.06-1.06L11.06 10l3.72-3.72a.75.75 0 0 0-1.06-1.06L10 8.94 6.28 5.22Z" }) });
}
function MobileSidebar2({ open, close, className, children }) {
  return /* @__PURE__ */ jsxs13(Headless18.Dialog, { open, onClose: close, className: "lg:hidden", children: [
    /* @__PURE__ */ jsx24(Headless18.DialogBackdrop, { transition: true, className: "fixed inset-0 bg-black/30 transition data-closed:opacity-0 data-enter:duration-300 data-leave:duration-200 data-enter:ease-out data-leave:ease-in" }),
    /* @__PURE__ */ jsx24(Headless18.DialogPanel, { transition: true, className: "data-closed:-translate-x-full fixed inset-y-0 w-full max-w-80 p-2 transition duration-300 ease-in-out", children: /* @__PURE__ */ jsxs13("div", { className: clsx22([className ?? "bg-white dark:bg-zinc-900", "flex h-full flex-col rounded-lg shadow-xs ring-1 ring-zinc-950/5 dark:ring-white/10"]), children: [
      /* @__PURE__ */ jsx24("div", { className: "-mb-3 px-4 pt-3", children: /* @__PURE__ */ jsx24(Headless18.CloseButton, { as: NavbarItem, "aria-label": "Close navigation", children: /* @__PURE__ */ jsx24(CloseMenuIcon2, {}) }) }),
      children
    ] }) })
  ] });
}
function StackedLayout({ navbar, sidebar, className, children }) {
  ...
  return /* @__PURE__ */ jsxs13("div", { className: clsx22([children && "min-h-svh", className ?? "bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950", "relative isolate flex w-full flex-col"]), children: [
    /* @__PURE__ */ jsx24(MobileSidebar2, { open: showSidebar, close: () => setShowSidebar(false), children: sidebar }),
    /* @__PURE__ */ jsxs13("header", { className: "flex items-center px-4", children: [
      /* @__PURE__ */ jsx24("div", { className: "py-2.5 lg:hidden", children: /* @__PURE__ */ jsx24(NavbarItem, { onClick: () => setShowSidebar(true), "aria-label": "Open navigation", children: /* @__PURE__ */ jsx24(OpenMenuIcon2, {}) }) }),
      /* @__PURE__ */ jsx24("div", { className: "min-w-0 flex-1", children: navbar })
    ] }),
    children && /* @__PURE__ */ jsx24("main", { className: "flex flex-1 flex-col pb-2 lg:px-2", children: /* @__PURE__ */ jsx24("div", { className: clsx22(["grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10"]), children: /* @__PURE__ */ jsx24("div", { className: "mx-auto max-w-6xl", children }) }) })
  ] });
}
...
function Table({
  ...
  return /* @__PURE__ */ jsx26(TableContext.Provider, { value: { bleed, dense, grid, striped }, children: /* @__PURE__ */ jsx26("div", { className: "flow-root", children: /* @__PURE__ */ jsx26("div", { ...props, className: clsx24(className, "-mx-(--gutter) overflow-x-auto whitespace-nowrap"), children: /* @__PURE__ */ jsx26("div", { className: clsx24("inline-block min-w-full align-middle", !bleed && "sm:px-(--gutter)"), children: /* @__PURE__ */ jsx26("table", { className: "min-w-full text-left text-sm/6 text-zinc-950 dark:text-white", children }) }) }) }) });
}
function TableHead({ className, ...props }) {
  return /* @__PURE__ */ jsx26("thead", { ...props, className: clsx24(className, "text-zinc-500 dark:text-zinc-400") });
}
function TableBody(props) {
  return /* @__PURE__ */ jsx26("tbody", { ...props });
}
...
function TableRow({ href, target, title, className, ...props }) {
  ...
  return /* @__PURE__ */ jsx26(TableRowContext.Provider, { value: { href, target, title }, children: /* @__PURE__ */ jsx26(
    "tr",
    {
      ...props,
      className: clsx24(
...
function TableCell({ className, children, ...props }) {
  ...
  return /* @__PURE__ */ jsxs14(
    "td",
    {
      ...
      children: [
        href && /* @__PURE__ */ jsx26(Link, { "data-row-link": true, href, target, "aria-label": title, tabIndex: cellRef?.previousElementSibling === null ? 0 : -1, className: "absolute inset-0 focus:outline-hidden" }),
        children
      ]
    }
  );
