...
export function Listbox({ className, placeholder, autoFocus, 'aria-label': ariaLabel, children: options, ...props }) {
    return (_jsxs(Headless.Listbox, { ...props, multiple: false, children: [_jsxs(Headless.ListboxButton
            // eslint-disable-next-line jsx-a11y/no-autofocus
            , { 
                // eslint-disable-next-line jsx-a11y/no-autofocus
                autoFocus: autoFocus, "data-slot": "control", "aria-label": ariaLabel, className: clsx([
                    className,
                    // Basic layout
...
export function ListboxDescription({ className, children, ...props }) {
    return (_jsx("span", { ...props, className: clsx(className, 'flex flex-1 overflow-hidden text-zinc-500 before:w-2 before:min-w-0 before:shrink group-data-focus/option:text-white dark:text-zinc-400'), children: _jsx("span", { className: "flex-1 truncate", children: children }) }));
}
