...
export function Badge({ color = 'zinc', className, ...props }) {
    return _jsx("span", { ...props, className: clsx(className, 'inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 font-medium text-sm/5 sm:text-xs/5 forced-colors:outline', colors[color]) });
}
