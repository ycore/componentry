...
export declare function DropdownButton<T extends ElementType = typeof Button>({ as, ...props }: {
    className?: string;
...
export declare function DropdownHeader({ className, ...props }: ComponentPropsWithoutRef<'div'>): import("react/jsx-runtime").JSX.Element;
