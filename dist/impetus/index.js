...
function ProductionErrorDisplay({ message, detail }) {
  return /* @__PURE__ */ jsx("main", { className: "flex h-screen items-center justify-center p-6", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-sm flex-col items-center gap-4 text-center", children: [
    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-lg", children: message }),
      /* @__PURE__ */ jsx("p", { className: "text-base text-muted-foreground italic", children: detail })
    ] }),
    /* @__PURE__ */ jsx(Link$1, { to: href("/"), className: "rounded-xl bg-accent px-8 py-2", children: "Back to home" })
  ] }) });
}
...
function GeneralErrorBoundary({ isDev = false }) {
  ...
  return /* @__PURE__ */ jsx(ProductionErrorDisplay, { message, detail });
}
