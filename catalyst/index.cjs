...
var catalyst_exports = {};
__export(catalyst_exports, {
  Alert: () => Alert2,
  ...
  SwitchGroup: () => SwitchGroup2,
  Table: () => Table2,
  Text: () => Text2,
  Textarea: () => Textarea2
});
module.exports = __toCommonJS(catalyst_exports);
...
function AuthLayout({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("main", { className: "flex min-h-dvh flex-col p-2", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex grow items-center justify-center p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10", children }) });
}
...
function Divider({ soft = false, className, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("hr", { ...props, className: (0, import_clsx10.default)(className, "w-full border-t", soft && "border-zinc-950/5 dark:border-white/5", !soft && "border-zinc-950/10 dark:border-white/10") });
}
